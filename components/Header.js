    ...
    <header className={styles.header}>
      <div className="contenedor">
        <div className={styles.barra}>
          {/* no es necesario apuntar por que next ya reconoce que el image pero es necesario ponerle width y height o layout="fill" */}
          <Link href="/">
            <a>
              <Image height={100} width={400} src="/img/logo.svg" alt="logo" />
            </a>
          </Link>
